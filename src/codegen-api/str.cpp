...
const std::vector<std::string> codegenStr = {
  ...
  R"(char *str_at (_{err_state_t} *fn_err_state, int line, int col, _{struct str} s, _{int32_t} i) {)" EOL
  ...
  R"(double str_toFloat (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self) {)" EOL
  ...
  R"(float str_toF32 (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self) {)" EOL
  R"(  char *c = _{str_cstr}(self);)" EOL
  R"(  char *e = _{NULL};)" EOL
  R"(  _{errno} = 0;)" EOL
  ...
  R"(double str_toF64 (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self) {)" EOL
  R"(  char *c = _{str_cstr}(self);)" EOL
  R"(  char *e = _{NULL};)" EOL
  R"(  _{errno} = 0;)" EOL
  R"(  double r = _{strtod}(c, &e);)" EOL
  ...
  R"(_{int32_t} str_toInt (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self, unsigned char o1, _{int32_t} n1) {)" EOL
  ...
  R"(_{int8_t} str_toI8 (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self, unsigned char o1, _{int32_t} n1) {)" EOL
  R"(  if (o1 == 1 && (n1 < 2 || n1 > 36) && n1 != 0) {)" EOL
  R"(    const char *fmt = "radix %" _{PRId32} " is invalid, must be >= 2 and <= 36, or 0";)" EOL
  R"(    _{size_t} z = _{snprintf}(_{NULL}, 0, fmt, n1);)" EOL
  R"(    char *d = _{alloc}(z + 1);)" EOL
  ...
  R"(_{int16_t} str_toI16 (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self, unsigned char o1, _{int32_t} n1) {)" EOL
  R"(  if (o1 == 1 && (n1 < 2 || n1 > 36) && n1 != 0) {)" EOL
  R"(    const char *fmt = "radix %" _{PRId32} " is invalid, must be >= 2 and <= 36, or 0";)" EOL
  R"(    _{size_t} z = _{snprintf}(_{NULL}, 0, fmt, n1);)" EOL
  R"(    char *d = _{alloc}(z + 1);)" EOL
  ...
  R"(_{int32_t} str_toI32 (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self, unsigned char o1, _{int32_t} n1) {)" EOL
  R"(  if (o1 == 1 && (n1 < 2 || n1 > 36) && n1 != 0) {)" EOL
  R"(    const char *fmt = "radix %" _{PRId32} " is invalid, must be >= 2 and <= 36, or 0";)" EOL
  R"(    _{size_t} z = _{snprintf}(_{NULL}, 0, fmt, n1);)" EOL
  R"(    char *d = _{alloc}(z + 1);)" EOL
  ...
  R"(_{int64_t} str_toI64 (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self, unsigned char o1, _{int32_t} n1) {)" EOL
  R"(  if (o1 == 1 && (n1 < 2 || n1 > 36) && n1 != 0) {)" EOL
  R"(    const char *fmt = "radix %" _{PRId32} " is invalid, must be >= 2 and <= 36, or 0";)" EOL
  R"(    _{size_t} z = _{snprintf}(_{NULL}, 0, fmt, n1);)" EOL
  R"(    char *d = _{alloc}(z + 1);)" EOL
  ...
  R"(_{uint8_t} str_toU8 (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self, unsigned char o1, _{int32_t} n1) {)" EOL
  R"(  if (o1 == 1 && (n1 < 2 || n1 > 36) && n1 != 0) {)" EOL
  R"(    const char *fmt = "radix %" _{PRId32} " is invalid, must be >= 2 and <= 36, or 0";)" EOL
  R"(    _{size_t} z = _{snprintf}(_{NULL}, 0, fmt, n1);)" EOL
  R"(    char *d = _{alloc}(z + 1);)" EOL
  ...
  R"(_{uint16_t} str_toU16 (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self, unsigned char o1, _{int32_t} n1) {)" EOL
  R"(  if (o1 == 1 && (n1 < 2 || n1 > 36) && n1 != 0) {)" EOL
  R"(    const char *fmt = "radix %" _{PRId32} " is invalid, must be >= 2 and <= 36, or 0";)" EOL
  R"(    _{size_t} z = _{snprintf}(_{NULL}, 0, fmt, n1);)" EOL
  R"(    char *d = _{alloc}(z + 1);)" EOL
  ...
  R"(_{uint32_t} str_toU32 (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self, unsigned char o1, _{int32_t} n1) {)" EOL
  R"(  if (o1 == 1 && (n1 < 2 || n1 > 36) && n1 != 0) {)" EOL
  R"(    const char *fmt = "radix %" _{PRId32} " is invalid, must be >= 2 and <= 36, or 0";)" EOL
  R"(    _{size_t} z = _{snprintf}(_{NULL}, 0, fmt, n1);)" EOL
  R"(    char *d = _{alloc}(z + 1);)" EOL
  ...
  R"(_{uint64_t} str_toU64 (_{err_state_t} *fn_err_state, int line, int col, _{struct str} self, unsigned char o1, _{int32_t} n1) {)" EOL
  R"(  if (o1 == 1 && (n1 < 2 || n1 > 36) && n1 != 0) {)" EOL
  R"(    const char *fmt = "radix %" _{PRId32} " is invalid, must be >= 2 and <= 36, or 0";)" EOL
  R"(    _{size_t} z = _{snprintf}(_{NULL}, 0, fmt, n1);)" EOL
  R"(    char *d = _{alloc}(z + 1);)" EOL
