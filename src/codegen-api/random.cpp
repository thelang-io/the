...
const std::vector<std::string> codegenRandom = {
  R"(double random_randomFloat (_{err_state_t} *fn_err_state, int line, int col, unsigned char o1, double n1, unsigned char o2, double n2) {)" EOL
  ...
  R"(_{int32_t} random_randomInt (_{err_state_t} *fn_err_state, int line, int col, unsigned char o1, _{int32_t} n1, unsigned char o2, _{int32_t} n2) {)" EOL
  ...
  R"(_{struct str} random_randomStr (_{err_state_t} *fn_err_state, int line, int col, unsigned char o1, _{struct str} n1, unsigned char o2, _{int32_t} n2) {)" EOL
