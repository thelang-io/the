...
extern inline const std::map<std::string, std::set<std::string>> codegenMetadata = {
  ...
  std::pair<std::string, std::set<std::string>>{"threadpool_t", {"typeThreadpool"}},
  std::pair<std::string, std::set<std::string>>{"threadpool_cond_t", {"typeThreadpoolCond"}},
  std::pair<std::string, std::set<std::string>>{"threadpool_func_t", {"typeThreadpoolFunc"}},
  std::pair<std::string, std::set<std::string>>{"threadpool_job_t", {"typeThreadpoolJob"}},
  std::pair<std::string, std::set<std::string>>{"threadpool_mutex_t", {"typeThreadpoolMutex"}},
  std::pair<std::string, std::set<std::string>>{"threadpool_thread_t", {"typeThreadpoolThread"}},
  ...
  std::pair<std::string, std::set<std::string>>{"pthread_t", {"libPthread"}},
  std::pair<std::string, std::set<std::string>>{"pthread_cond_t", {"libPthread"}},
  std::pair<std::string, std::set<std::string>>{"pthread_mutex_t", {"libPthread"}},
  std::pair<std::string, std::set<std::string>>{"pthread_cond_destroy", {"libPthread"}},
  std::pair<std::string, std::set<std::string>>{"pthread_cond_init", {"libPthread"}},
  std::pair<std::string, std::set<std::string>>{"pthread_cond_signal", {"libPthread"}},
  std::pair<std::string, std::set<std::string>>{"pthread_cond_wait", {"libPthread"}},
  ...
  std::pair<std::string, std::set<std::string>>{"pthread_mutex_unlock", {"libPthread"}},
  std::pair<std::string, std::set<std::string>>{"pthread_threadid_np", {"libPthread"}},
  ...
  std::pair<std::string, std::set<std::string>>{"SYS_gettid", {"libSysSyscall"}},
  ...
  std::pair<std::string, std::set<std::string>>{"syscall", {"libUnistd"}},
  ...
  std::pair<std::string, std::set<std::string>>{"CONDITION_VARIABLE", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"CREATE_NEW", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"CREATE_SUSPENDED", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"CRITICAL_SECTION", {"libWindows"}},
  ...
  std::pair<std::string, std::set<std::string>>{"INFINITE", {"libWindows"}},
  ...
  std::pair<std::string, std::set<std::string>>{"LPTHREAD_START_ROUTINE", {"libWindows"}},
  ...
  std::pair<std::string, std::set<std::string>>{"PROCESSOR_ARCHITECTURE_ALPHA", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"PROCESSOR_ARCHITECTURE_ALPHA64", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"PROCESSOR_ARCHITECTURE_AMD64", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"PROCESSOR_ARCHITECTURE_ARM", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"PROCESSOR_ARCHITECTURE_ARM64", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"PROCESSOR_ARCHITECTURE_IA32_ON_WIN64", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"PROCESSOR_ARCHITECTURE_IA64", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"PROCESSOR_ARCHITECTURE_INTEL", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"PROCESSOR_ARCHITECTURE_MIPS", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"PROCESSOR_ARCHITECTURE_PPC", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"PROCESSOR_ARCHITECTURE_SHX", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"SYMBOLIC_LINK_FLAG_DIRECTORY", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"SYSTEM_INFO", {"libWindows"}},
  ...
  std::pair<std::string, std::set<std::string>>{"EnterCriticalSection", {"libWindows"}},
  ...
  std::pair<std::string, std::set<std::string>>{"GetCurrentThreadId", {"libWindows"}},
  ...
  std::pair<std::string, std::set<std::string>>{"GetSystemInfo", {"libWindows"}},
  ...
  std::pair<std::string, std::set<std::string>>{"InitializeConditionVariable", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"InitializeCriticalSection", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"LeaveCriticalSection", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"MemoryBarrier", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"RemoveDirectory", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"ResumeThread", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"Sleep", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"SleepConditionVariableCS", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"WaitForSingleObject", {"libWindows"}},
  std::pair<std::string, std::set<std::string>>{"WakeConditionVariable", {"libWindows"}},
