...
void TypeMap::_anyType (TypeMapPhase phase) {
  this->_initType("any", phase, [&] (auto selfType, [[maybe_unused]] auto refSelfType) {
    ...
    auto strTypeFn = TypeFn{this->get("str"), {}, strCallInfo.throws, true, strCallInfo};
...
void TypeMap::_charType (TypeMapPhase phase) {
  this->_initType("char", phase, [&] (auto selfType, [[maybe_unused]] auto refSelfType) {
    ...
    }, repeatCallInfo.throws, true, repeatCallInfo};
...
void TypeMap::_strType (TypeMapPhase phase) {
  this->_initType("str", phase, [&] (auto selfType, [[maybe_unused]] auto refSelfType) {
    ...
    }, containsCallInfo.throws, true, containsCallInfo};
    ...
    auto findTypeFn = TypeFn{this->get("int"), {
      TypeFnParam{"search", selfType, false, true, false}
    }, findCallInfo.throws, true, findCallInfo};
    ...
    }, linesCallInfo.throws, true, linesCallInfo};
    ...
    }, replaceCallInfo.throws, true, replaceCallInfo};
    ...
    }, sliceCallInfo.throws, true, sliceCallInfo};
    ...
    }, splitCallInfo.throws, true, splitCallInfo};
    ...
    auto toBufferTypeFn = TypeFn{this->get("buffer_Buffer"), {}, toBufferCallInfo.throws, true, toBufferCallInfo};
    ...
    auto toFloatTypeFn = TypeFn{this->get("float"), {}, toFloatCallInfo.throws, true, toFloatCallInfo};
    ...
    auto toF32TypeFn = TypeFn{this->get("f32"), {}, toF32CallInfo.throws, true, toF32CallInfo};
    ...
    auto toF64TypeFn = TypeFn{this->get("f64"), {}, toF64CallInfo.throws, true, toF64CallInfo};
    ...
    }, toIntCallInfo.throws, true, toIntCallInfo};
    ...
    auto toI8TypeFn = TypeFn{this->get("i8"), {
      TypeFnParam{"radix", this->get("int"), false, false, false}
    }, toI8CallInfo.throws, true, toI8CallInfo};
    ...
    auto toI16TypeFn = TypeFn{this->get("i16"), {
      TypeFnParam{"radix", this->get("int"), false, false, false}
    }, toI16CallInfo.throws, true, toI16CallInfo};
    ...
    auto toI32TypeFn = TypeFn{this->get("i32"), {
      TypeFnParam{"radix", this->get("int"), false, false, false}
    }, toI32CallInfo.throws, true, toI32CallInfo};
    ...
    auto toI64TypeFn = TypeFn{this->get("i64"), {
      TypeFnParam{"radix", this->get("int"), false, false, false}
    }, toI64CallInfo.throws, true, toI64CallInfo};
    ...
    auto toU8TypeFn = TypeFn{this->get("u8"), {
      TypeFnParam{"radix", this->get("int"), false, false, false}
    }, toU8CallInfo.throws, true, toU8CallInfo};
    ...
    auto toU16TypeFn = TypeFn{this->get("u16"), {
      TypeFnParam{"radix", this->get("int"), false, false, false}
    }, toU16CallInfo.throws, true, toU16CallInfo};
    ...
    auto toU32TypeFn = TypeFn{this->get("u32"), {
      TypeFnParam{"radix", this->get("int"), false, false, false}
    }, toU32CallInfo.throws, true, toU32CallInfo};
    ...
    auto toU64TypeFn = TypeFn{this->get("u64"), {
      TypeFnParam{"radix", this->get("int"), false, false, false}
    }, toU64CallInfo.throws, true, toU64CallInfo};
    ...
    auto trimTypeFn = TypeFn{selfType, {}, trimCallInfo.throws, true, trimCallInfo};
    ...
    auto trimEndTypeFn = TypeFn{selfType, {}, trimEndCallInfo.throws, true, trimEndCallInfo};
    ...
    auto trimStartTypeFn = TypeFn{selfType, {}, trimStartCallInfo.throws, true, trimStartCallInfo};
...
void TypeMap::_dateModule (TypeMapPhase phase) {
  if (phase == TYPE_MAP_DEF) {
    ...
    auto date_nowTypeFn = TypeFn{this->get("u64"), {}, date_nowCallInfo.throws, false, date_nowCallInfo};
...
void TypeMap::_errorModule (TypeMapPhase phase) {
  if (phase == TYPE_MAP_DEF) {
    ...
    }, error_NewErrorCallInfo.throws, false, error_NewErrorCallInfo};
...
void TypeMap::_fsModule (TypeMapPhase phase) {
  if (phase == TYPE_MAP_DEF) {
    ...
    }, fs_appendFileSyncCallInfo.throws, false, fs_appendFileSyncCallInfo};
    ...
    }, fs_chmodSyncCallInfo.throws, false, fs_chmodSyncCallInfo};
    ...
    }, fs_chownSyncCallInfo.throws, false, fs_chownSyncCallInfo};
    ...
    }, fs_copyDirectorySyncCallInfo.throws, false, fs_copyDirectorySyncCallInfo};
    ...
    auto fs_copyFileSyncTypeFn = TypeFn{this->get("void"), {
      TypeFnParam{"source", this->get("str"), false, true, false},
      TypeFnParam{"destination", this->get("str"), false, true, false}
    }, fs_copyFileSyncCallInfo.throws, false, fs_copyFileSyncCallInfo};
    ...
    auto fs_existsSyncTypeFn = TypeFn{this->get("bool"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_existsSyncCallInfo.throws, false, fs_existsSyncCallInfo};
    ...
    auto fs_isAbsoluteSyncTypeFn = TypeFn{this->get("bool"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_isAbsoluteSyncCallInfo.throws, false, fs_isAbsoluteSyncCallInfo};
    ...
    auto fs_isDirectorySyncTypeFn = TypeFn{this->get("bool"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_isDirectorySyncCallInfo.throws, false, fs_isDirectorySyncCallInfo};
    ...
    auto fs_isFileSyncTypeFn = TypeFn{this->get("bool"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_isFileSyncCallInfo.throws, false, fs_isFileSyncCallInfo};
    ...
    auto fs_isSymbolicLinkSyncTypeFn = TypeFn{this->get("bool"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_isSymbolicLinkSyncCallInfo.throws, false, fs_isSymbolicLinkSyncCallInfo};
    ...
    }, fs_linkSyncCallInfo.throws, false, fs_linkSyncCallInfo};
    ...
    auto fs_mkdirSyncTypeFn = TypeFn{this->get("void"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_mkdirSyncCallInfo.throws, false, fs_mkdirSyncCallInfo};
    ...
    auto fs_readFileSyncTypeFn = TypeFn{this->get("buffer_Buffer"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_readFileSyncCallInfo.throws, false, fs_readFileSyncCallInfo};
    ...
    auto fs_realpathSyncTypeFn = TypeFn{this->get("str"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_realpathSyncCallInfo.throws, false, fs_realpathSyncCallInfo};
    ...
    auto fs_renameSyncTypeFn = TypeFn{this->get("void"), {
      TypeFnParam{"source", this->get("str"), false, true, false},
      TypeFnParam{"destination", this->get("str"), false, true, false}
    }, fs_renameSyncCallInfo.throws, false, fs_renameSyncCallInfo};
    ...
    auto fs_rmSyncTypeFn = TypeFn{this->get("void"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_rmSyncCallInfo.throws, false, fs_rmSyncCallInfo};
    ...
    auto fs_rmdirSyncTypeFn = TypeFn{this->get("void"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_rmdirSyncCallInfo.throws, false, fs_rmdirSyncCallInfo};
    ...
    auto fs_scandirSyncTypeFn = TypeFn{this->createArr(this->get("str")), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_scandirSyncCallInfo.throws, false, fs_scandirSyncCallInfo};
    ...
    auto fs_statSyncTypeFn = TypeFn{this->get("fs_Stats"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_statSyncCallInfo.throws, false, fs_statSyncCallInfo};
    ...
    auto fs_unlinkSyncTypeFn = TypeFn{this->get("void"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, fs_unlinkSyncCallInfo.throws, false, fs_unlinkSyncCallInfo};
    ...
    auto fs_writeFileSyncTypeFn = TypeFn{this->get("void"), {
      TypeFnParam{"path", this->get("str"), false, true, false},
      TypeFnParam{"data", this->get("buffer_Buffer"), false, true, false}
    }, fs_writeFileSyncCallInfo.throws, false, fs_writeFileSyncCallInfo};
...
void TypeMap::_globalsModule (TypeMapPhase phase) {
  if (phase == TYPE_MAP_DEF) {
    ...
    }, printCallInfo.throws, false, printCallInfo};
...
void TypeMap::_pathModule (TypeMapPhase phase) {
  if (phase == TYPE_MAP_DEF) {
    ...
    auto path_basenameTypeFn = TypeFn{this->get("str"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, path_basenameCallInfo.throws, false, path_basenameCallInfo};
    ...
    auto path_dirnameTypeFn = TypeFn{this->get("str"), {
      TypeFnParam{"path", this->get("str"), false, true, false}
    }, path_dirnameCallInfo.throws, false, path_dirnameCallInfo};
    ...
    auto path_tempDirectoryTypeFn = TypeFn{this->get("str"), {}, path_tempDirectoryCallInfo.throws, false, path_tempDirectoryCallInfo};
    ...
    auto path_tempFileTypeFn = TypeFn{this->get("str"), {}, path_tempDirectoryCallInfo.throws, false, path_tempFileCallInfo};
...
void TypeMap::_processModule (TypeMapPhase phase) {
  if (phase == TYPE_MAP_DEF) {
    ...
    auto process_cwdTypeFn = TypeFn{this->get("str"), {}, process_cwdCallInfo.throws, false, process_cwdCallInfo};
    ...
    }, process_exitCallInfo.throws, false, process_exitCallInfo};
    ...
    auto process_getgidTypeFn = TypeFn{this->get("int"), {}, process_getgidCallInfo.throws, false, process_getgidCallInfo};
    ...
    auto process_getuidTypeFn = TypeFn{this->get("int"), {}, process_getuidCallInfo.throws, false, process_getuidCallInfo};
    ...
    }, process_runSyncCallInfo.throws, false, process_runSyncCallInfo};
...
void TypeMap::_randomModule (TypeMapPhase phase) {
  if (phase == TYPE_MAP_DEF) {
    ...
    }, random_randomFloatCallInfo.throws, false, random_randomFloatCallInfo};
    ...
    }, random_randomIntCallInfo.throws, false, random_randomIntCallInfo};
    ...
    }, random_randomStrCallInfo.throws, false, random_randomStrCallInfo};
...
void TypeMap::_requestModule (TypeMapPhase phase) {
  if (phase == TYPE_MAP_DEF) {
    ...
    this->_initType("request_Request", phase, [&] (auto selfType, auto refSelfType) {
      ...
      auto closeTypeFn = TypeFn{this->get("void"), {}, closeCallInfo.throws, true, closeCallInfo};
      ...
      auto readTypeFn = TypeFn{this->get("request_Response"), {}, readCallInfo.throws, true, readCallInfo};
    ...
    }, request_openCallInfo.throws, false, request_openCallInfo};
...
void TypeMap::_threadModule (TypeMapPhase phase) {
  if (phase == TYPE_MAP_DEF) {
    ...
    }, thread_sleepCallInfo.throws, false, thread_sleepCallInfo};
...
void TypeMap::_urlModule (TypeMapPhase phase) {
  if (phase == TYPE_MAP_DEF) {
    ...
    auto url_parseTypeFn = TypeFn{this->get("url_URL"), {
      TypeFnParam{"url", this->get("str"), false, true, false}
    }, url_parseCallInfo.throws, false, url_parseCallInfo};
...
void TypeMap::_utilsModule (TypeMapPhase phase) {
  if (phase == TYPE_MAP_DEF) {
    ...
    }, utils_swapCallInfo.throws, false, utils_swapCallInfo};
...
void TypeMap::_arrTypeDef (Type *selfType, Type *refSelfType, Type *elementType, Type *refElementType) {
  ...
  auto clearTypeFn = TypeFn{refSelfType, {}, clearCallInfo.throws, true, clearCallInfo};
  ...
  auto concatCallInfo = TypeCallInfo{typeName(selfType->name + "_concat"), true, "self_0", selfType, false, true};
  auto concatTypeFn = TypeFn{selfType, {
    TypeFnParam{"other", selfType, false, true, false}
  }, concatCallInfo.throws, true, concatCallInfo};
  ...
  auto containsCallInfo = TypeCallInfo{typeName(selfType->name + "_contains"), true, "self_0", selfType, false, elementType->shouldBeFreed()};
  auto containsTypeFn = TypeFn{this->get("bool"), {
  ...
  auto forEachCallInfo = TypeCallInfo{typeName(selfType->name + "_forEach"), true, "self_0", selfType, false, elementType->shouldBeFreed()};
  ...
  auto joinCallInfo = TypeCallInfo{typeName(selfType->name + "_join"), true, "self_0", selfType, false, true};
  auto joinTypeFn = TypeFn{this->get("str"), {
    TypeFnParam{"separator", this->get("str"), false, false, false}
  }, joinCallInfo.throws, true, joinCallInfo};
  ...
  auto mergeCallInfo = TypeCallInfo{typeName(selfType->name + "_merge"), true, "self_0", refSelfType, true, true};
  auto mergeTypeFn = TypeFn{refSelfType, {
    TypeFnParam{"other", selfType, false, true, false}
  }, mergeCallInfo.throws, true, mergeCallInfo};
  ...
  auto popTypeFn = TypeFn{elementType, {}, popCallInfo.throws, true, popCallInfo};
  ...
  auto pushCallInfo = TypeCallInfo{typeName(selfType->name + "_push"), true, "self_0", refSelfType, true, true};
  auto pushTypeFn = TypeFn{this->get("void"), {
    TypeFnParam{"elements", this->createArr(elementType), false, false, true}
  }, pushCallInfo.throws, true, pushCallInfo};
  ...
  }, removeCallInfo.throws, true, removeCallInfo};
  ...
  auto reverseCallInfo = TypeCallInfo{typeName(selfType->name + "_reverse"), true, "self_0", selfType, false, true};
  auto reverseTypeFn = TypeFn{selfType, {}, reverseCallInfo.throws, true, reverseCallInfo};
  ...
  auto sliceCallInfo = TypeCallInfo{typeName(selfType->name + "_slice"), true, "self_0", selfType, false, true};
  auto sliceTypeFn = TypeFn{selfType, {
    TypeFnParam{"start", this->get("int"), false, false, false},
    TypeFnParam{"end", this->get("int"), false, false, false}
  }, sliceCallInfo.throws, true, sliceCallInfo};
  ...
  selfType->fields.push_back(TypeField{"slice", this->_items.back().get(), false, true});
  auto sortCallInfo = TypeCallInfo{typeName(selfType->name + "_sort"), true, "self_0", refSelfType, true, elementType->shouldBeFreed()};
  ...
  auto strCallInfo = TypeCallInfo{typeName(selfType->name + "_str"), true, "self_0", selfType, false, true};
  auto strTypeFn = TypeFn{this->get("str"), {}, strCallInfo.throws, true, strCallInfo};
...
void TypeMap::_enumTypeDef (Type *selfType, [[maybe_unused]] Type *refSelfType) {
  auto rawValueCallInfo = TypeCallInfo{typeName(selfType->codeName + "_rawValue"), true, "self_0", selfType, false, true};
...
void TypeMap::_mapTypeDef (Type *selfType, Type *refSelfType, Type *keyType, Type *valueType) {
  ...
  auto keysCallInfo = TypeCallInfo{typeName(selfType->name + "_keys"), true, "self_0", selfType, false, true};
  selfType->fields.push_back(TypeField{"keys", this->createArr(keyType), false, true, keysCallInfo});
  auto lenCallInfo = TypeCallInfo{typeName(selfType->name + "_len"), true, "self_0", selfType, false, false};
  selfType->fields.push_back(TypeField{"len", this->get("int"), false, true, lenCallInfo});
  auto valuesCallInfo = TypeCallInfo{typeName(selfType->name + "_values"), true, "self_0", selfType, false, true};
  ...
  }, getCallInfo.throws, true, getCallInfo};
  ...
  auto hasCallInfo = TypeCallInfo{typeName(selfType->name + "_has"), true, "self_0", selfType, false, keyType->shouldBeFreed()};
  auto hasTypeFn = TypeFn{this->get("bool"), {
    TypeFnParam{"key", keyType, false, true, false}
  }, hasCallInfo.throws, true, hasCallInfo};
  ...
  selfType->fields.push_back(TypeField{"remove", this->_items.back().get(), false, true});
  auto reserveCallInfo = TypeCallInfo{typeName(selfType->name + "_reserve"), true, "self_0", refSelfType, true, true};
  auto reserveTypeFn = TypeFn{refSelfType, {
    TypeFnParam{"size", this->get("int"), false, true, false}
  }, reserveCallInfo.throws, true, reserveCallInfo};
  ...
  auto setCallInfo = TypeCallInfo{typeName(selfType->name + "_set"), true, "self_0", refSelfType, true, true};
  auto setTypeFn = TypeFn{refSelfType, {
    TypeFnParam{"key", keyType, false, true, false},
    TypeFnParam{"value", valueType, false, true, false}
  }, setCallInfo.throws, true, setCallInfo};
  ...
  auto shrinkCallInfo = TypeCallInfo{typeName(selfType->name + "_shrink"), true, "self_0", refSelfType, true, true};
  auto shrinkTypeFn = TypeFn{refSelfType, {}, shrinkCallInfo.throws, true, shrinkCallInfo};
