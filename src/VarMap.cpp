...
void VarMap::init (TypeMap &typeMap) {
  ...
  this->_items.push_back(std::make_shared<Var>(Var{"fs_unlinkSync", "@fs_unlinkSync", typeMap.get("fs_unlinkSync"), false, true, this->_frame}));
  ...
  this->_items.push_back(std::make_shared<Var>(Var{"path_SEP", "@path_SEP", typeMap.get("str"), false, true, this->_frame}));
