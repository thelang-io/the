...
void VarMap::init (TypeMap &typeMap) {
  ...
  this->_items.push_back(std::make_shared<Var>(Var{"math_FloatMax", "@math_FloatMax", typeMap.get("float"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_FloatMin", "@math_FloatMin", typeMap.get("float"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_F32Max", "@math_F32Max", typeMap.get("f32"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_F32Min", "@math_F32Min", typeMap.get("f32"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_F64Max", "@math_F64Max", typeMap.get("f64"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_F64Min", "@math_F64Min", typeMap.get("f64"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_IntMax", "@math_IntMax", typeMap.get("int"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_IntMin", "@math_IntMin", typeMap.get("int"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_I8Max", "@math_I8Max", typeMap.get("i8"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_I8Min", "@math_I8Min", typeMap.get("i8"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_I16Max", "@math_I16Max", typeMap.get("i16"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_I16Min", "@math_I16Min", typeMap.get("i16"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_I32Max", "@math_I32Max", typeMap.get("i32"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_I32Min", "@math_I32Min", typeMap.get("i32"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_I64Max", "@math_I64Max", typeMap.get("i64"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_I64Min", "@math_I64Min", typeMap.get("i64"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_U8Max", "@math_U8Max", typeMap.get("u8"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_U8Min", "@math_U8Min", typeMap.get("u8"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_U16Max", "@math_U16Max", typeMap.get("u16"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_U16Min", "@math_U16Min", typeMap.get("u16"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_U32Max", "@math_U32Max", typeMap.get("u32"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_U32Min", "@math_U32Min", typeMap.get("u32"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_U64Max", "@math_U64Max", typeMap.get("u64"), false, false, true, false, this->_frame}));
  this->_items.push_back(std::make_shared<Var>(Var{"math_U64Min", "@math_U64Min", typeMap.get("u64"), false, false, true, false, this->_frame}));
  ...
  this->_items.push_back(std::make_shared<Var>(Var{"process_env", "@process_env", typeMap.createMap(typeMap.get("str"), typeMap.get("str"), true), false, false, true, false, this->_frame}));
  ...
  this->_items.push_back(std::make_shared<Var>(Var{"random_randomString", "@random_randomString", typeMap.get("random_randomString"), false, false, true, false, this->_frame}));
