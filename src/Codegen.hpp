...
class Codegen {
 ...
 private:
  ...
  void _block (CodegenASTStmt *, const ASTBlock &, bool = true, const std::optional<CodegenASTStmt> & = std::nullopt, bool = false);
  void _blockAsync (CodegenASTStmt *, const ASTBlock &, bool = true, const std::optional<CodegenASTStmt> & = std::nullopt, bool = false);
  std::tuple<std::map<std::string, Type *>, std::map<std::string, Type *>> _evalTypeCasts (const ASTNodeExpr &, const ASTNode &);
  CodegenASTExpr _exprAccess (const ASTNodeExpr &, Type *, const ASTNode &, CodegenASTStmt *, bool);
  CodegenASTExpr _exprArray (const ASTNodeExpr &, Type *, const ASTNode &, CodegenASTStmt *, bool);
  CodegenASTExpr _exprAssign (const ASTNodeExpr &, Type *, const ASTNode &, CodegenASTStmt *, bool);
  CodegenASTExpr _exprAwait (const ASTNodeExpr &, Type *, const ASTNode &, CodegenASTStmt *, bool);
  ...
  CodegenASTExpr _exprRef (const ASTNodeExpr &, Type *, const ASTNode &, CodegenASTStmt *, bool);
  CodegenASTExpr _exprUnary (const ASTNodeExpr &, Type *, const ASTNode &, CodegenASTStmt *, bool);
  void _fnDecl (CodegenASTStmt *, std::shared_ptr<Var>, const std::vector<std::shared_ptr<Var>> &, const std::vector<ASTFnDeclParam> &, const std::optional<ASTBlock> &, const ASTNode &, CodegenPhase);
  CodegenASTExpr _genCopyFn (Type *, const CodegenASTExpr &);
  CodegenASTExpr _genEqFn (Type *, const CodegenASTExpr &, const CodegenASTExpr &, bool = false);
  CodegenASTExpr _genFreeFn (Type *, const CodegenASTExpr &);
  CodegenASTExpr _genReallocFn (Type *, const CodegenASTExpr &, const CodegenASTExpr &);
  CodegenASTExpr _genStrFn (Type *, const CodegenASTExpr &, bool = true, bool = true);
  void _node (CodegenASTStmt *, const ASTNode &, CodegenPhase = CODEGEN_PHASE_FULL);
  void _nodeAsync (CodegenASTStmt *, const ASTNode &, CodegenPhase = CODEGEN_PHASE_FULL);
  void _nodeBreak (CodegenASTStmt *, const ASTNode &);
  void _nodeBreakAsync (CodegenASTStmt *, const ASTNode &);
  void _nodeContinue (CodegenASTStmt *, const ASTNode &);
  void _nodeContinueAsync (CodegenASTStmt *, const ASTNode &);
  void _nodeEnumDecl (CodegenASTStmt *, const ASTNode &, CodegenPhase);
  void _nodeExprDecl (CodegenASTStmt *, const ASTNode &);
  void _nodeExprDeclAsync (CodegenASTStmt *, const ASTNode &);
  CodegenASTExpr _nodeExpr (const ASTNodeExpr &, Type *, const ASTNode &, CodegenASTStmt *, bool = false, std::size_t = 0);
  void _nodeFnDecl (CodegenASTStmt *, const ASTNode &, CodegenPhase);
  void _nodeIf (CodegenASTStmt *, const ASTNode &);
  void _nodeIfAsync (CodegenASTStmt *, const ASTNode &);
  void _nodeLoop (CodegenASTStmt *, const ASTNode &);
  void _nodeLoopAsync (CodegenASTStmt *, const ASTNode &);
  void _nodeMain (CodegenASTStmt *, const ASTNode &);
  void _nodeMainAsync (CodegenASTStmt *, const ASTNode &);
  void _nodeObjDecl (CodegenASTStmt *, const ASTNode &, CodegenPhase);
  void _nodeReturn (CodegenASTStmt *, const ASTNode &);
  void _nodeReturnAsync (CodegenASTStmt *, const ASTNode &);
  void _nodeThrow (CodegenASTStmt *, const ASTNode &);
  void _nodeThrowAsync (CodegenASTStmt *, const ASTNode &);
  void _nodeTry (CodegenASTStmt *, const ASTNode &);
  void _nodeTryAsync (CodegenASTStmt *, const ASTNode &);
  void _nodeVarDecl (CodegenASTStmt *, const ASTNode &);
  void _nodeVarDeclAsync (CodegenASTStmt *, const ASTNode &);
  CodegenASTExpr _nodeVarDeclInit (const CodegenTypeInfo &);
