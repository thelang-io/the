...
class Codegen {
 ...
 private:
  ...
  CodegenASTStmt &_node (CodegenASTStmt &, const ASTNode &, CodegenPhase = CODEGEN_PHASE_FULL);
  CodegenASTStmt &_nodeAsync (CodegenASTStmt &, const ASTNode &, CodegenPhase = CODEGEN_PHASE_FULL);
  ...
  CodegenASTStmt &_nodeEnumDecl (CodegenASTStmt &, const ASTNode &, CodegenPhase);
  CodegenASTStmt &_nodeExprDecl (CodegenASTStmt &, const ASTNode &);
  CodegenASTStmt &_nodeExprDeclAsync (CodegenASTStmt &, const ASTNode &);
  CodegenASTExpr _nodeExpr (const ASTNodeExpr &, Type *, const ASTNode &, CodegenASTStmt &, bool = false, std::size_t = 0);
  CodegenASTStmt &_nodeFnDecl (CodegenASTStmt &, const ASTNode &, CodegenPhase);
