...
class Codegen {
 ...
 private:
  ...
  CodegenASTExpr _genCopyFn (Type *, const std::string &);
  CodegenASTExpr _genEqFn (Type *, const std::string &, const std::string &, bool = false);
  CodegenASTExpr _genFreeFn (Type *, const std::string &);
  CodegenASTExpr _genReallocFn (Type *, const std::string &, const std::string &);
  CodegenASTExpr _genStrFn (Type *, const std::string &, bool = true, bool = true);
