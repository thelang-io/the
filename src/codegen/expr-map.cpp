...
std::shared_ptr<CodegenASTExpr> Codegen::_exprMap (const ASTNodeExpr &nodeExpr, Type *targetType, const ASTNode &parent, std::shared_ptr<CodegenASTStmt> *c, bool root) {
