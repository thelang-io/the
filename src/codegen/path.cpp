...
const std::vector<std::string> codegenPath = {
  ...
  R"(        _{free}(d);)" EOL
  R"(        _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("failed to generate random with `SystemFunction036`"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  ...
  R"(  if (d == _{NULL}) {)" EOL
  R"(    _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("failed to create temporary directory"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  R"(    _{longjmp}(_{err_state}.buf[_{err_state}.buf_idx - 1], _{err_state}.id);)" EOL
  R"(  })" EOL
  ...
  R"(  if (d == _{NULL}) {)" EOL
  R"(    _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("failed to create temporary file"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  R"(    _{longjmp}(_{err_state}.buf[_{err_state}.buf_idx - 1], _{err_state}.id);)" EOL
  R"(  })" EOL
  R"(  _{struct str} r = _{str_alloc}(d);)" EOL
  R"(  _{free}(d);)" EOL
  ...
  R"(    if (l == 0) {)" EOL
  R"(      _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("failed to get temporary path"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  R"(      _{longjmp}(_{err_state}.buf[_{err_state}.buf_idx - 1], _{err_state}.id);)" EOL
  R"(    })" EOL
  R"(    l -= 1;)" EOL
  R"(    d = _{alloc}(l + 1);)" EOL
