...
const std::vector<std::string> codegenRequest = {
  ...
  R"(        _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("failed to initialize use of Windows Sockets DLL"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  R"(        goto request_open_cleanup1;)" EOL
  R"(      })" EOL
  ...
  R"(    _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("failed to resolve hostname address"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  ...
  R"(  if (!socket_res) {)" EOL
  R"(    req_free = 1;)" EOL
  R"(    _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("failed to create socket"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  ...
  R"(      req_free = 1;)" EOL
  R"(      _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("failed to create SSL context"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  R"(      goto request_open_cleanup4;)" EOL
  R"(    })" EOL
  ...
  R"(      req_free = 1;)" EOL
  R"(      _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("failed to connect to socket with SSL"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  ...
  R"(    if (z < 0) {)" EOL
  R"(      req_free = 1;)" EOL
  R"(      _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("failed to write to socket"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  ...
  R"(    if (y < 0) {)" EOL
  R"(      _{free}(data.d);)" EOL
  R"(      _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("failed to read from socket"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  ...
  R"(  } else {)" EOL
  R"(    _{free}(data.d);)" EOL
  R"(    _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("invalid response HTTP version"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  R"(    _{longjmp}(_{err_state}.buf[_{err_state}.buf_idx - 1], _{err_state}.id);)" EOL
  R"(  })" EOL
  ...
  R"(    _{free}(data.d);)" EOL
  R"(    _{error_assign}(&_{err_state}, _{TYPE_error_Error}, (void *) _{error_Error_alloc}(_{str_alloc}("invalid response HTTP status code"), (_{struct str}) {_{NULL}, 0}), line, col);)" EOL
  R"(    _{longjmp}(_{err_state}.buf[_{err_state}.buf_idx - 1], _{err_state}.id);)" EOL
  R"(  })" EOL
