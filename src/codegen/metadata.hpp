...
extern const std::map<std::string, std::set<std::string>> codegenMetadata = {
  ...
  std::pair<std::string, std::set<std::string>>{"buffer_to_str", {"fnBufferToStr"}},
  ...
  std::pair<std::string, std::set<std::string>>{"enum_str", {"fnEnumStr"}},
  ...
  std::pair<std::string, std::set<std::string>>{"str_toBuffer", {"fnStrToBuffer"}},
